...
var you = document.getElementById("you-img");
var root = document.getElementById("root");
var main = document.getElementById("new-year-body");
canvas.style.display = "none";
const snowFall = () => {
    const bg = document.querySelector(".bg");
    for (let i = 0; i < 170; i++) {
      const snow = document.createElement("span");
      snow.style.backgroundColor = pcolor[i%8];
  ...
  const glowingText = (count) => {
    ...
    btn.addEventListener("click", () => {
      ...
      if(count == 2)
      btn.innerHTML = "Them Lan Nua!";
      else
      btn.innerHTML = "Lan Nua!";
